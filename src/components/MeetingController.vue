...
<template>
  <div class="w-full bg-slate-50">
    <div class="flex h-16 w-full items-center justify-center bg-slate-500 sm:hidden">
      ...
      <!-- 設定 -->
      <ButtonGeneralSecondary class="w-18 m-0 me-2 h-12 p-0" @click="emit('open-settings')">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
          height="24"
    ...
    <div class="hidden h-16 w-full bg-slate-500 sm:flex sm:items-center sm:justify-between">
      <!-- dummy -->
      ...
      <div class="mx-3 flex items-center justify-center">
        ...
        <ButtonGeneralPrimary class="me-2 h-12 w-12" @click="emit('change-view-mode')">
          ...
          <template #explain>ビューモード切替</template>
        </ButtonGeneralPrimary>
        <!-- // change View mode -->
      ...
      <div class="mx-3 flex items-center justify-center">
        ...
        <ButtonGeneralSecondary class="me-2 h-12 w-12" @click="emit('open-settings')">
          ...
          <template #explain>各種の<br />設定</template>
        </ButtonGeneralSecondary>
        <!-- // 設定 -->
        ...
        <ButtonGeneralDanger class="me-2 h-12 w-16" @click="emit('exit-room')">
          退室
          <template #explain>ミーティングを退室します</template>
        </ButtonGeneralDanger>
        <!-- // 退室 -->
      </div>
    </div>
