...
onMounted(async () => {
  ...
  mediaStream.value = mediaStreamBlurStore.getMediaStream() as MediaStream
  //
  ...
  <div class="h-full w-full bg-slate-100 p-3">
    ...
    <div class="mx-auto">
      <div class="my-3 flex items-center justify-center">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-arrow-left-right" viewBox="-2 -2 20 20">
